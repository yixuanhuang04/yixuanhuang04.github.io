...
(function (window, document) {
  ...
  function main() {
    ...
    function adjustElements(data) {
      ...
      $(".clustrmaps-visitors, .clustrmaps-date")
        .css("font-size", uF + "px")
        .css("line-height", "16px")
        .css("color", "#" + ct);

      $(".clustrmaps-bottom-text")
        .css("font-size", dF + "px")
        .css("line-height", lH + "px")
        .css("color", "white");

      $(
        "<div class=clustrmaps-loading style='display: table; height: 100%; overflow: hidden; width:100%'><div style='font-size: 14px;font-family: \"Helvetica Neue\", Arial; color: white; text-shadow: 1px 1px 0 #01324f; display: table-cell; vertical-align: middle; text-align: center'>Loading data...</div></div>",
      ).appendTo($(".clustrmaps-map"));
    }
  ...
  function embed_clustrmaps(script_el, embed_after_script) {
    if ($("#clustrmaps-widget-v2").length === 0) {
      /*
        ...
        */
      var link =
        '<a target="_top" href="http://clustrmaps.com/?utm_source=widget&utm_medium=js_widget&utm_campaign=widget_ctr" id="clustrmaps-widget-v2">';
      ...
      (function (t) {
        ...
        function e(e) {
          ...
          if (
            ...
            "wheelDeltaX" in r && (m = -1 * r.wheelDeltaX),
            "axis" in r &&
              r.axis === r.HORIZONTAL_AXIS &&
              ((m = -1 * c), (c = 0)),
            (l = 0 === c ? m : c),
            "deltaY" in r && ((c = -1 * r.deltaY), (l = c)),
            "deltaX" in r && ((m = r.deltaX), 0 === c && (l = -1 * m)),
            0 !== c || 0 !== m)
          ) {
            if (1 === r.deltaMode) {
            ...
            return (
              (p = Math.max(Math.abs(c), Math.abs(m))),
              (!n || n > p) && ((n = p), s(r, p) && (n /= 40)),
              s(r, p) && ((l /= 40), (m /= 40), (c /= 40)),
    ...
    ((jvm.$ = jQuery),
          ...
          ? jvm.SVGShapeElement.images[e]
            ...
            : jvm.whenImageLoaded(e).then(function (t) {
                ((s = new jvm.SVGElement("image")),
                  ...
                  (a = new jvm.SVGElement("pattern")),
                  a.applyAttr("id", "image" + jvm.SVGShapeElement.imageCounter),
                  a.applyAttr("x", 0),
                  a.applyAttr("y", 0),
      ...
      (jvm.VMLCanvasElement.prototype.setSize = function (t, e) {
        ...
        if (
          ...
          for (
            a = this.rootElement.node.getElementsByTagName("shape"),
              i = 0,
              n = a.length;
            n > i;
            i++
          ...
          for (
            s = this.node.getElementsByTagName("group"), i = 0, n = s.length;
            n > i;
            i++
          )
            ((s[i].coordsize = t + " " + e),
      ...
      (jvm.NumericScale = function (t, e, a, s) {
        ((this.scale = []),
          ...
          "undefined" != typeof a && this.setMin(a),
          "undefined" != typeof s && this.setMax(s));
      }),
        ...
        getValue: function (t) {
          ...
          for (
            ...
            ((e = this.vectorLength(
              ...
              (i += e));
          for (
            a = (this.maxValue - this.minValue) / i, n = 0;
            n < s.length;
            n++
          )
            s[n] *= a;
          ...
          for (
            0.15 >= r
              ...
              : 0.35 >= r
                ? (n *= 5)
                : 0.75 >= r && (n *= 2),
              s[0] = Math.floor(s[0] / n) * n,
              s[1] = Math.ceil(s[1] / n) * n,
              t = s[0];
            t <= s[1];
          )
            ((e =
              t == s[0]
                ...
                : t == s[1]
                  ? this.clearMaxValue
                  : t),
              o.push({ label: t, value: this.getValue(e) }),
              (t += n));
          return o;
        },
      }),
      ...
      (jvm.ColorScale.arrayToRgb = function (t) {
        ...
        for (a = 0; a < t.length; a++)
          ((e = t[a].toString(16)), (s += 1 == e.length ? "0" + e : e));
        return s;
      }),
      ...
      (jvm.DataSeries.prototype = {
        setAttributes: function (t, e) {
          ...
          if ("string" == typeof t)
            this.elements[t] &&
              this.elements[t].setStyle(this.params.attribute, e);
          else
            for (a in s)
              this.elements[a] &&
        ...
        setValues: function (t) {
          ...
          if (
            ...
            for (a in t)
              t[a]
                ...
                : void 0 != this.elements[a] &&
                  (n[a] =
                    this.elements[a].element.style.initial[
            ...
            if (
              ...
              for (a in t)
                ((e = parseFloat(t[a])), e > s && (s = e), i > e && (i = e));
            ("undefined" == typeof this.params.min
      ...
      (jvm.Proj = {
        ...
        lcc_inv: function (t, e, a) {
          var s = t / this.radius,
            ...
            h = 45 * this.radDeg,
            l =
              Math.log(Math.cos(o) * (1 / Math.cos(h))) /
              Math.log(
          ...
          return {
            lat:
              (2 * Math.atan(Math.pow(m / p, 1 / l)) - Math.PI / 2) *
              this.degRad,
            lng: (r + d / l) * this.degRad,
          };
        },
      ...
      (jvm.Map.prototype = {
        ...
        applyTransform: function () {
          ...
          if (
            ...
            waitForFinalEvent(
              function () {
                (i.repositionMarkers(),
                  i.container.find("g:eq(2)").css("visibility", "visible"));
              },
              80,
              "repositionMarkers",
            );
        ...
        bindContainerTouchEvents: function () {
          var t,
            ...
            h = function (h) {
              var l,
                ...
                c,
                p,
                d = h.originalEvent.touches;
              ("touchstart" == h.type && (r = 0),
                1 == d.length
                  ? (1 == r &&
                      ((c = o.transX),
                      (p = o.transY),
                      (o.transX -= (a - d[0].pageX) / o.scale),
                      (o.transY -= (s - d[0].pageY) / o.scale),
                      o.applyTransform(),
                      o.tip.hide(),
                      (c != o.transX || p != o.transY) && h.preventDefault()),
                    (a = d[0].pageX),
                    (s = d[0].pageY))
                  : 2 == d.length &&
                    (2 == r
          ...
          (jvm.$(this.container).bind("touchstart", h),
            jvm.$(this.container).bind("touchmove", h));
        },
            ...
            this.container.delegate(
              ...
              function (t) {
                var a =
                    ...
                    jvm.$(this).attr("class"),
                  s =
                    -1 === a.indexOf("jvectormap-region") ? "marker" : "region",
                  i = jvm
                    .$(this)
                    .attr("region" == s ? "data-code" : "data-index"),
                  n =
                    "region" == s ? e.regions[i].element : e.markers[i].element,
                  r =
                    "region" == s
                ...
                "mouseover" == t.type
                  ? (e.container.trigger(h, [i]),
                    h.isDefaultPrevented() || n.setHovered(!0),
                    e.tip.text(r),
                    e.container.trigger(o, [e.tip, i]),
                  ...
                  : (n.setHovered(!1),
                    e.tip.hide(),
                    e.container.trigger(s + "Out.jvectormap", [i]));
              },
            ),
            this.container.delegate(
              "[class~='jvectormap-element']",
            ...
            this.container.delegate(
              ...
              function () {
                ...
                t ||
                  ...
                  (("region" === s && e.params.regionsSelectable) ||
                    ("marker" === s && e.params.markersSelectable)) &&
        ...
        bindZoomButtons: function () {
          ...
          (jvm
            ...
            this.container.find("svg").dblclick(function (e) {
                ...
                ? ((p =
                  ...
                  (d =
                    ...
                    (this.defaultHeight *
                      ...
                      2))
                : ((p = this.transX - ((u - 1) / t) * e),
                  (d = this.transY - ((u - 1) / t) * a))),
            i && j > 0
              ? ((r = this.scale),
                (o = (t - r) / j),
                ...
                (n = setInterval(function () {
                  ((f += 1),
                    (g.scale = r + o * f),
                    (g.transX = (h + l * f) / g.scale),
                    (g.transY = (m + c * f) / g.scale),
                    g.applyTransform(),
                    f == j &&
                      (clearInterval(n),
                      g.container.trigger(v, [t / g.baseScale]),
                      y.resolve()));
                }, 10)))
              : ((this.transX = p),
                (this.transY = d),
        ...
        setFocus: function (t) {
          ...
          if (
            ((t = t || {}),
            t.region ? (i = [t.region]) : t.regions && (i = t.regions),
            i)
          ) {
            for (n = 0; n < i.length; n++)
              this.regions[i[n]] &&
                ((a = this.regions[i[n]].element.shape.getBBox()),
                a &&
                  ("undefined" == typeof e
                    ? (e = a)
                    : ((s = {
          ...
          return (
            t.lat && t.lng
              ? ((r = this.latLngToPoint(t.lat, t.lng)),
                (t.x = this.transX - r.x / this.scale),
                (t.y = this.transY - r.y / this.scale))
              : t.x &&
                t.y &&
        ...
        addMarker: function (t, e, a) {
          ...
          for (n[t] = e, i = 0; i < a.length; i++)
            ((s = {}), "undefined" != typeof a[i] && (s[t] = a[i]), r.push(s));
          this.addMarkers(n, r);
        },
        ...
        latLngToPoint: function (t, e) {
          ...
          return (
            ...
            s
              ? ((i = s.bbox),
                (a.x =
                  ((a.x - i[0].x) / (i[1].x - i[0].x)) * s.width * this.scale),
                (a.y =
                  ((a.y - i[0].y) / (i[1].y - i[0].y)) * s.height * this.scale),
                {
        ...
        getInsetForPoint: function (t, e) {
          ...
          for (a = 0; a < i.length; a++)
            if (
              ((s = i[a].bbox),
              t > s[0].x && t < s[1].x && e > s[0].y && e < s[1].y)
            )
              return i[a];
        },
      ...
      (jvm.MultiMap.prototype = {
        ...
        goBack: function () {
          var t = this.history.pop(),
            ...
            a = this;
          t.setFocus({ scale: 1, x: 0.5, y: 0.5, animate: !0 }).then(
            function () {
    ...
    (function ($) {
      ...
      function getViewportOffset() {
        return {
          ...
          left:
            w.pageXOffset || documentElement.scrollLeft || d.body.scrollLeft,
        };
      }
      ...
      function checkInView() {
        ...
        $.each(inviewObjects, function (i, inviewObject) {
          ...
          $elements = $elements.add(
            selector ? $element.find(selector) : $element,
          );
        });
